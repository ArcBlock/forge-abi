...
defmodule ForgeAbi.RequestStartSimulator do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule ForgeAbi.ResponseStartSimulator do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  defstruct [:code, :result]

  field :code, 1, type: ForgeAbi.StatusCode, enum: true
  field :result, 2, type: :string
end

defmodule ForgeAbi.RequestStopSimulator do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule ForgeAbi.ResponseStopSimulator do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule ForgeAbi.RequestGetSimulatorStatus do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule ForgeAbi.ResponseGetSimulatorStatus do
  @moduledoc false
  use Protobuf, syntax: :proto3
